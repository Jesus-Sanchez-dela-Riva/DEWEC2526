...
parrafo.innerHTML+="Dale a empezar para generar los cuadrados para matarlos<br>"
parrafo.innerHTML+="Tienes 60 segundos para matarlos <br>Si a los 60 segundos no lo has matado<br>Puedes darle al boton de empezar para volver a intentarlo<br>"
parrafo.innerHTML+="Los botones de pausar y reinicira no funcionan, si les das no hacen nada<br>"
parrafo.innerHTML+="Los cuadrados tienen 20 vidas, si les das las 20 veces los matas"
...
function crearSprite2(){
    ...
    sprite2=setInterval(()=>{
        ...
        if(posicion2>=300 || posicion2<=0){
            direccion2*=-1
        }
    } , 250)
    
}
let partidaAcabada= null
function finPartida(){
    setInterval(() => {
...
function limpiarFondo(){
    juego.style.backgroundImage="none"
}
